var egret = window.egret;window.skins={};
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/my_ui/ElementCube.exml'] = window.ElementCubeSkin = (function (_super) {
	__extends(ElementCubeSkin, _super);
	function ElementCubeSkin() {
		_super.call(this);
		this.skinParts = ["cubeImage"];
		
		this.height = 75;
		this.width = 75;
		this.elementsContent = [this.cubeImage_i()];
	}
	var _proto = ElementCubeSkin.prototype;

	_proto.cubeImage_i = function () {
		var t = new eui.Image();
		this.cubeImage = t;
		t.height = 75;
		t.source = "img_Cube1_png";
		t.width = 75;
		t.x = 0;
		t.y = 0;
		return t;
	...
	function WelcomeSkin() {
		...
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.header_i(),this.body_i(),this.footer_i()];
	}
	...
	_proto.header_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Rect2_i(),this.lableHead_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
		t.fillColor = 0xea5480;
		t.height = 55;
		t.scaleX = 1;
		t.scaleY = 1;
		t.percentWidth = 100;
	...
	_proto.btChangeState_i = function () {
		var t = new eui.Button();
