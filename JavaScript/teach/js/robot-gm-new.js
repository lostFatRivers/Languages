...
let vm = new Vue({
    ...
    data: {
        ...
        minRobotId: 0,
        maxRobotId: 0,
        wsAddress: 'ws://127.0.0.1:8090/websocket',
        websocketConn: null,
        connectStatus: "",
        pageIndex: 0
    },
    ...
    methods: {
        ...
        initData() {
            ...
            // axios.get('./static/data/robot.json').then(res => {
            //     // success
            //     console.log(res.data);
            //     this.assembleRobotData(res.data.robot);
            // }, err => {
            //     // error
            //     console.log(err);
            // });
        ...
        sendMessage(jsonStr) {
            if (!this.websocketConn || this.websocketConn.readyState != 1) {
                return;
            }
